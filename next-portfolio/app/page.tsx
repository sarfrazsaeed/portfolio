...
export default function HomePage() {
  return <SmoothScroll><main>
    ...
    <Experience />
    <section className="section-shell border-t border-ink/10 py-16 dark:border-white/10 sm:py-20"><Reveal><div className="flex items-end justify-between gap-5"><div><p className="eyebrow">Keep exploring</p><h2 className="mt-3 font-display text-3xl">More of the <em>work.</em></h2></div><a href="/projects" className="home-pill">Projects <span aria-hidden="true">↗</span></a></div><p className="mt-5 max-w-xs text-xs leading-5 text-ink/60 dark:text-white/65">Browse the interfaces I’ve built, or see the credentials behind the practice.</p><div className="mt-4 flex flex-wrap gap-2 text-[10px] font-bold"><a className="home-pill" href="/certifications">Certifications <span aria-hidden="true">↗</span></a><a className="home-pill" href="/contact">Contact <span aria-hidden="true">↗</span></a></div></Reveal></section>
  </main></SmoothScroll>;
}
